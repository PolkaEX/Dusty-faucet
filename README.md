## git commit "Astar Dusty Network faucet"

### Building from source

1. Clone repository
  ```
  git clone https://github.com/PolkaEX/dusty-faucet
  ```
...
5. Run faucet with `npm start`. Astar Dusty Network faucet will be launched at `http://localhost:5000`
...
```
{
  ...
  "Ethereum": {
    ...
    "prod": {
      "rpc": "JSON RPC endpoint. For example, http://eth.dusty.astar.network",
